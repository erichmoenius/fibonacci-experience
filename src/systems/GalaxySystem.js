...
export class GalaxySystem {
  ...
  update(delta) {
    this.innerGroup.rotation.y -= delta * 0.0272;
    this.spinGroup.rotation.y -= delta * 0.01496;
    this.outerGroup.rotation.y -= delta * 0.00748;
    this.haloGroup.rotation.y -= delta * 0.00136;
